        ...
        <div className='bg-white flex flex-col items-center justify-center font-serif'>
            ...
            ">
                <div className="flex items-center pl-6" data-aos="fade-zoom-in"
                    ...
                    <img src="./compressedImages/image5(crop).jpg" alt="Image 1" className="w-[237px] h-[304px] sm:w-auto sm:max-w-xs rounded-xl" />
                    <div className='mx-4'>
                ...
                <div className="flex items-center pl-6" data-aos="fade-zoom-in"
                    data-aos-easing="ease-in-back">
                    <img src="./compressedImages/image5(crop).jpg" alt="Image 2" className="w-[237px] h-[304px] rounded-xl " />
                    <div className='mx-4'>
