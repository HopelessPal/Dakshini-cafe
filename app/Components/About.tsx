                ...
                >
                    <SwiperSlide>
                        <div className="slider_inner_content relative">
                            <div className="image_content w-screen lg: md:h-screen relative">
                                <img src="/image1.JPG" alt="slider" className=' h-full object-cover relative' />
                                <div className="absolute inset-0 bg-black opacity-50"></div>
                            </div>
                            <div className="absolute md:top-1/2 top-1/3  md:left-48 left-10 text-left md:w-1/2 w-3/4 pt-[50px]">
